 ...
 */
let bigInt1: bigint = BigInt(1234); // Constructor syntax
let bigInt2: bigint = 1234n; // Literal syntax (more modern idiomatic way of declaring BigInt constants and preferred for hardcoded values)
console.log("bigInt1:", bigInt1);
console.log("bigInt2:", bigInt2);

let c: bigint = bigInt1 - bigInt2; // Yes you can use this way to substract the bigInt (eg; additional... etc)
